...
extern void Map3D_MoveBlockDirectionVertex(lpMap3D map, U32 bx, U32 by, Direction direction, Point3F* vertDist);
extern void Map3D_MoveBlockVertices(lpMap3D map, U32 bx, U32 by, F32 zDist);
